...
role="alert" > <h2>DATA DOKTER RS AL-ISLAM</h2>
 </div>
 <h1 class="ml-5">Tambah Data Dokter</h1>
 <form method="post"
action="prosestambahdata.php" class="ml-5">
 <div class="form-group row">
 <label for="nama" class="col-sm-1 col-formlabel">Nama</label>
 <div class="col-sm-3">
 <input type="text" name="nama" class="formcontrol" placeholder="Masukkan text">
 </div>
 </div>
 <div class="form-group row">
...
<input type="text" name="alamat" class="form-control" placeholder="Masukkan text">
 ...
 <div class="form-group row">
 <label for="tahun_masuk" class="col-sm-1 col-formlabel">Tahun Masuk</label>
 <div class="col-sm-3">
 <input type="number" name="tahun_masuk"
class="form-control" placeholder="Masukkan text">
 </div>
 </div>
 <div class="form-group row">
 <label for="spesialis" class="col-sm-1 col-formlabel">Spesialis </label>
 <div class="col-sm-3">
 <input type="text" name="spesialis" class="formcontrol" placeholder="Masukkan text">
 </div>
 </div>
<button type="submit" class="btn btn-primary mb-1
mt-1 ml-0 mr-0" >Kirim</button>
<a href="index.php" class="btn btn-primary mb-1 mt-1
ml-0"><i class="fas fa-user-plus mr-0"></i>Data Dokter</a>
</form>
 <!-- Optional JavaScript -->

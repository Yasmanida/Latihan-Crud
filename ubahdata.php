...
<h2>DATA DOKTER RS AL-ISLAM</h2>
 </div>
 <h1 class="ml-5">Ubah Data Dokter</h1>
...
value="<?php echo $data['alamat'] ?>" >
 ...
 <div class="form-group row">
 <label for="tahun_masuk" class="col-sm-1 col-formlabel">Tahun_Masuk</label>
 <div class="col-sm-3">
 <input type="number" name="tahun_masuk" class="formcontrol" value="<?php echo $data['tahun_masuk'] ?>" >
 </div>
 </div>
 <div class="form-group row">
